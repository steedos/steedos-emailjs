...
(function (root, factory) {
...
})(undefined, function (ImapClient, utf7, imapHandler, mimefuncs, addressparser) {
    'use strict';
    ...
    Client.prototype.connect = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            return _this2.updateId(_this2.options.id);
        }).then(function () {
            ...
            _this2.close(); // we don't really care whether this works or not
            throw err;
        });
    };
        ...
        return this.exec({
            ...
            [].concat([].concat(response.payload.ID.shift().attributes || []).shift() || []).forEach(function (val, i) {
                if (i % 2 === 0) {
                    ...
                    _this4.serverId[key] = (val && val.value || '').toString();
                }
            });
    ...
    Client.prototype.selectMailbox = function (path, options) {
        ...
        return this.exec(query, ['EXISTS', 'FLAGS', 'OK'], {
            ...
            setTimeout(function () {
                _this5.onselectmailbox && _this5.onselectmailbox(path, mailboxInfo);
            }, 0);
    ...
    Client.prototype.listMessages = function (path, sequence, items, options) {
        ...
        return this.exec(command, 'FETCH', {
            precheck: function precheck(ctx) {
                return _this8._selectedMailbox === path ? Promise.resolve() : _this8.selectMailbox(path, { ctx: ctx });
            }
        }).then(function (response) {
    ...
    Client.prototype.search = function (path, query, options) {
        ...
        return this.exec(command, 'SEARCH', {
            precheck: function precheck(ctx) {
                return _this9._selectedMailbox === path ? Promise.resolve() : _this9.selectMailbox(path, { ctx: ctx });
            }
        }).then(function (response) {
    ...
    Client.prototype.store = function (path, sequence, action, flags, options) {
        ...
        return this.exec(command, 'FETCH', {
            precheck: function precheck(ctx) {
                return _this10._selectedMailbox === path ? Promise.resolve() : _this10.selectMailbox(path, { ctx: ctx });
            }
        }).then(function (response) {
    ...
    Client.prototype.deleteMessages = function (path, sequence, options) {
        ...
        return this.setFlags(path, sequence, {
            ...
            return _this11.exec(cmd, null, {
                precheck: function precheck(ctx) {
                    return _this11._selectedMailbox === path ? Promise.resolve() : _this11.selectMailbox(path, { ctx: ctx });
                }
            });
        });
    };
    ...
    Client.prototype.copyMessages = function (path, sequence, destination, options) {
        ...
        return this.exec({
            ...
            precheck: function precheck(ctx) {
                return _this12._selectedMailbox === path ? Promise.resolve() : _this12.selectMailbox(path, { ctx: ctx });
            }
        }).then(function (response) {
    ...
    Client.prototype.moveMessages = function (path, sequence, destination, options) {
        ...
        return this.exec({
            ...
            precheck: function precheck(ctx) {
                return _this13._selectedMailbox === path ? Promise.resolve() : _this13.selectMailbox(path, { ctx: ctx });
            }
        });
    };
    ...
    Client.prototype.exec = function (request, acceptUntagged, options) {
        ...
        return this.breakIdle().then(function () {
            return _this16.client.enqueueCommand(request, acceptUntagged, options);
        }).then(function (response) {
    ...
    Client.prototype._untaggedCapabilityHandler = function (response) {
        this._capability = [].concat(response && response.attributes || []).map(function (capa) {
            return (capa.value || '').toString().toUpperCase().trim();
        });
    };
    ...
    Client.prototype._parseBODYSTRUCTURE = function (value) {
        ...
        var processNode = function processNode(node, path) {
            path = path || [];
    ...
    Client.prototype.createLogger = function () {
        ...
        var createLogger = function createLogger(tag) {
            var log = function log(level, messages) {
                ...
                if (level === _this22.LOG_LEVEL_DEBUG) {
                    console.log('[DEBUG]' + logMessage);
                } else if (level === _this22.LOG_LEVEL_INFO) {
                    console.info('[INFO]' + logMessage);
                } else if (level === _this22.LOG_LEVEL_WARN) {
                    console.warn('[WARN]' + logMessage);
                } else if (level === _this22.LOG_LEVEL_ERROR) {
...
//# sourceMappingURL=emailjs-imap-client.js.map
